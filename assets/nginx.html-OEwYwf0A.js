import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as a,f as s}from"./app-XffPLay1.js";const n={},d=s(`<h2 id="负载均衡算法" tabindex="-1"><a class="header-anchor" href="#负载均衡算法" aria-hidden="true">#</a> 负载均衡算法</h2><h3 id="_1、轮询-默认" tabindex="-1"><a class="header-anchor" href="#_1、轮询-默认" aria-hidden="true">#</a> 1、轮询（默认）</h3><p>每个请求按时间顺序逐一分配到不同的后端服务，如果后端某台服务器死机，自动剔除故障系统，使用户访问不受影响。</p><p>例如：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>upstream bakend {
    server 192.168.0.1;
    server 192.168.0.2;
}
