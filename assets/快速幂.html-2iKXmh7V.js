import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as d,c as a,f as i,a as e,b as s}from"./app-XffPLay1.js";const c={},p=i(`<h1 id="快速幂" tabindex="-1"><a class="header-anchor" href="#快速幂" aria-hidden="true">#</a> 快速幂</h1><p>求 <code>m^k%p</code>，时间复杂度 <code>O(logk)</code></p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>int qmi(int m, int k, int p)
{
    int res = 1 % p, t = m;
    while (k)
    {
