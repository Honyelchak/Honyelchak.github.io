import{_ as p}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as i,o,c,a as n,b as s,e as t,f as a}from"./app-2Xbp2Heq.js";const l={},r=a(`<h1 id="位运算总结" tabindex="-1"><a class="header-anchor" href="#位运算总结" aria-hidden="true">#</a> 位运算总结</h1><h2 id="经典理论" tabindex="-1"><a class="header-anchor" href="#经典理论" aria-hidden="true">#</a> 经典理论</h2><h3 id="异或" tabindex="-1"><a class="header-anchor" href="#异或" aria-hidden="true">#</a> 异或</h3><p>异或，可以理解为<mark>不进位加法</mark>（相同则0，不同则1）</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>x^x = 0;
x^0 = x;
